...
public class DetalheLoteActivity extends AppCompatActivity {
    ...
    private TextView txtAvesInicial, txtAvesVivas, txtAvesMortas, txtIdade, txtMortalidade, txtPesoMedio, txtViabilidade, txtConsumoTotal, txtCA, txtGMP;
    ...
    private void initViews() {
        ...
        txtGMP = findViewById(R.id.txtIndicadorGMP);
    ...
    private void atualizarIndicadores(List<RegistroEntity> registros) {
        ...
        int idade = ZootecniaCalculator.calcularIdadeDias(currentLote, new java.util.Date()); // Ajustado para data atual no detalhe
        ...
        double gmp = ZootecniaCalculator.calcularGanhoMedioPeso(currentLote, registros, new java.util.Date());
        ...
        txtGMP.setText(gmp > 0 ? String.format(Locale.getDefault(), "%.2f g", gmp) : "---");
    }
